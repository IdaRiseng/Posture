...
enum class Movement(@StringRes val title: Int, @DrawableRes val illustration: Int, @RawRes val video: Int, val info: MovementInfo?) {
    ...
    BACK_SWIM(R.string.back_swim, R.drawable.back_swim, R.raw.back_swim, MovementInfo(illustration = null, R.string.back_swim_desc)),
    CAT_COW(R.string.cat_cow, R.drawable.cat_cow, R.raw.cat_cow, MovementInfo(illustration = null, R.string.cat_cow_desc)),
    THORACIC_ROTATION(R.string.thoracic_rotation, R.drawable.thoracic_rotation, R.raw.thoracic_rotation, MovementInfo(illustration = null, R.string.thoracic_rotation_desc)),
    EXTENDED_PUPPYPOSE(R.string.extended_puppy_pose, R.drawable.extended_puppypose, R.raw.extended_puppypose, MovementInfo(illustration = null, R.string.extended_puppy_pose_desc)),
    LOTUS_POSE(R.string.lotus_pose, R.drawable.lotus_pose, R.raw.lotus_pose, MovementInfo(illustration = null, R.string.lotus_pose_desc)),

    YWTS(R.string.y_w_t_s, R.drawable.y_w_t, R.raw.y_w_t, MovementInfo(illustration = null, R.string.y_w_t_s_desc)),
    SHOULDER_DISLOCATIONS(R.string.shoulder_dislocations, R.drawable.shoulder_disloactions, R.raw.shoulder_dislocations, MovementInfo(illustration = null, R.string.shoulder_dislocations_desc)),
}
